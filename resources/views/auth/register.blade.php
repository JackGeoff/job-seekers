    ...
    <div class="animate-fade-in" x-data="{
        ...
        <form method="POST" action="{{ route('register.store') }}" class="space-y-5" @submit="isSubmitting = true">
            ...
            <div>
                ...
                <input type="tel" id="phone" name="phone" value="{{ old('phone') }}" placeholder="254700000000" inputmode="numeric" pattern="[0-9]+" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required autocomplete="tel"
